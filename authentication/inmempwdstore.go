...
// Pbkdf2Hash is a cryptogaphic hash generated by PBKDF2 using SHA-256 for an
// InMemPwdStore. The iteration count must be at least Pbkdf2MinIterations to
// be accepted by this implementation.
